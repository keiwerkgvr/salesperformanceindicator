...
$dbuser		= "root";//$dbuser		= "salesper_order";
$dbpass		= "mysql2015";//$dbpass		= "{|!@#order@31}";
...
<html lang="en">
    <head>
        ...
        <link href="https://salesperformanceindicator.com/css/app.css" rel="stylesheet">
        <link rel="stylesheet" href="https://salesperformanceindicator.com/css/bootstrap.css">
        <link rel="stylesheet" href="https://salesperformanceindicator.com/css/fixes.css">
        ...
        <link rel="stylesheet" href="https://salesperformanceindicator.com/css/bootswatch.min.css">
        <!-- Fonts -->
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">
                        <img class="hidden-xs hidden-sm img-responsive" src="https://salesperformanceindicator.com/images/modLogo.png" alt="logo description" />
                        <img class="hidden-xs visible-sm img-responsive" src="https://salesperformanceindicator.com/images/modLogo-half.png" alt="logo description" />
                        <img class="visible-xs img-responsive" src="https://salesperformanceindicator.com/images/modLogo-small.png" alt="logo description" />
                    </a>
                </div>
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li><img class="img-responsive" src="https://salesperformanceindicator.com/images/presented-edited.png" />&nbsp;</li>
                    </ul>
                </div>
                ...
                <form method="POST" id="formID" action="" accept-charset="UTF-8" class="form-horizontal" mothod="POST">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group">
                            <label for="first_name	" class="col-lg-2 control-label">User Type</label>
                            <div class="col-lg-10" style="margin-top: 8px;">Existing User &nbsp;&nbsp;<input  name="usertype" id="exist" type="radio">&nbsp;&nbsp;&nbsp;&nbsp; New User&nbsp;&nbsp;<input  name="usertype" id="new" type="radio" checked="checked"></div>
                        </div>
