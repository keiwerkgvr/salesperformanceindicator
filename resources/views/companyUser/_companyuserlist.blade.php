                                            ...
                                            <table class="table">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-8 col-md-7 col-sm-6">
                                                        <h4>{{$user->first_name.' '.$user->last_name}}<b> Points</b> </h4>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-8 col-md-7 col-sm-6">
                                                        <h4 style="text-align: left;">{{$user->first_name.' '.$user->last_name}} <b>Points</b> </h4>
                                                    </div>
                                                </div>
                                                <div class="panel panel-default">
                                                    <div class="panel-body">
        ...
        <div class="tab-pane fade {{ ( $activeTab == 'report' ) ? 'active in' : ''  }}" id="reports">
                <div class="row ">
                    <table class="table">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-8 col-md-7 col-sm-6">
                                                        <h4 style="text-align: left;">All Users <b>Points</b> </h4>
                                                    </div>
                                                </div>
                                                <div class="panel panel-default">
                                                    <div class="panel-body">
